...
/* =========================================================
   MIKAEL F. KAISER — FREE HISTORY COMMISSION v119
...
(() => {
  ...
  if (window.__DDS_MIKAEL_HISTORY_FREE_V119__) return;
  window.__DDS_MIKAEL_HISTORY_FREE_V119__ = true;
  ...
  const defaults = Object.freeze({
    ...
    caseYear: "22",
    caseNo: "3345",
    fullName: "มิคาเอล เฟอร์รอส ไคเซอร์",
    aliases: "Mikael, Kel, Kelly",
    faceclaim: "Huening Kai",
    birthplace: "London, UK",
    dateOfBirth: "29/09/1859",
    species: "Vampire",
    level: "4",
    age: "165 YEARS",
    mbti: "INFJ",
    education: "Master of Economics",
    occupation: "Producer, Pianist",
    note: "Married",
    reference4: "2203",
    reportDate: "30/9/2026",
    history: "มิคาเอลเป็นลูกชายเพียงคนเดียวของตระกูลขุนนางชั้นเอิร์ลที่มั่งคั่งอย่างไคเซอร์ ด้วยการครอบครองเหมืองแร่ และกิจการเจียระไนเพชรพลอย จึงทำให้ตระกูลเอิร์ลไคเซอร์ เป็นตระกูลที่มั่งคั่งไปด้วยทรัพย์สินเงินทองอย่างมหาศาล มิคาเอลมีรูปร่างสูงโปร่ง หน้าตาที่หล่อเหลา ผิวขาว และดวงตาสีสวยอันเป็นที่ต้องมนต์ทุกคราที่ผู้ใดได้สบตา เขาเป็นชายหนุ่มที่นอกจากรูปงามแล้ว ยังฉลาดหลักแหลมอีกด้วย มิคาเอลเติบโตมาท่ามกลางความรักของบิดาและมารดา เขาที่ใช้ชีวิตมาอย่างดีท่ามกลางครอบครัวที่อบอุ่นและเงินทองอันมหาศาล แต่แล้วในวันหนึ่งที่เขาอายุได้ 25 ปี เขาได้ล้มป่วยกะทันหันด้วยโรคที่ไม่สามารถรักษาได้ เอิร์ลและเคาท์เตสไคเซอร์ได้เชิญหมอฝีมือดีมาทั่วทุกสารทิศ เรียกได้ว่าแทบจะพลิกแผ่นดินหา แม้กระทั่งหมอที่ได้ฉายาว่าเป็นหมอเทวดา ก็ไม่สามารถวินิจฉัยสาเหตุของโรคได้ ชายหนุ่มทำได้เพียงยอมรับชะตากรรมและใช้ชีวิตไปอย่างรอความตาย\n\nเอิร์ลและเคาท์เตสไคเซอร์นั้นทำใจไม่ได้ที่จะต้องทนเห็นลูกชายหัวแก้วหัวแหวนของตัวเองนั้นต้องตาย วันหนึ่ง เอิร์ลและเคาท์เตสไคเซอร์ไปได้ยินข่าวลือที่ว่ามีคนที่ใกล้ตายด้วยโรคที่ไม่มีทางรักษาหายได้แล้วกลับมาแข็งแรงและใช้ชีวิตได้อย่างปกติ คราแรก พวกเขาไม่ได้เชื่อข่าวลือนั่น แต่ด้วยความที่พวกเขาเองก็อับจนหนทางที่จะรักษาลูกชายของพวกเขาแล้ว จึงได้เดินทางไปพบคนผู้นั้นตามข่าวลือ\n\nเมื่อเดินทางไปถึง พวกเขาได้พบกับอาร์เธอร์ วินยาร์ด ลูกชายของบารอนวินยาร์ดที่ปกครองอาณาเขตนี้อยู่ อาร์เธอร์เล่าให้สองสามีภรรยาฟังว่าตอนที่เขาใกล้จะสิ้นใจ ท่านบารอนวินยาร์ดที่เป็นพ่อของเขานั้น ได้พาคนแปลก ๆ ผู้หนึ่งมา เขาทำการถ่ายเลือดของเขาให้กับอาร์เธอร์ หลังจากนั้นอาร์เธอร์ก็ได้รอดพ้นจากความตายและกลายเป็นแวมไพร์ในที่สุด นั่นจึงทำให้อาร์เธอร์รู้ว่าพ่อของเขานั้นได้ทำสัญญาลับ ๆ บางอย่างกับแวมไพร์ตนนั้น เอิร์ลและเคาท์เตสไคเซอร์เมื่อได้ยินดังนั้น ก็เกิดการลังเลขึ้นในใจลึก ๆ ว่าจะให้มิคาเอลนั้นกลายเป็นแวมไพร์ หรือปล่อยให้เขาจากไปอย่างสงบ แต่ด้วยความที่ทั้งคู่ไม่อยากให้ลูกชายสุดที่รักที่ใกล้สิ้นใจเต็มทีนั้นต้องตายในวัยหนุ่ม พวกเขาจึงได้ยื่นข้อเสนอให้อาร์เธอร์นั้น ทำการเปลี่ยนลูกชายของตนให้กลายเป็นแวมไพร์ แลกกับที่ดินทำเลทองส่วนหนึ่งในแถบอังกฤษให้กับวินยาร์ด\n\nบารอนวินยาร์ดและอาเธอร์ตอบรับข้อเสนอนี้ พวกเขาได้เดินทางกลับไปยังคฤหาสน์ไคเซอร์ทันทีเพื่อทำการถ่ายเลือดให้กับมิคาเอล ทำให้มิคาเอลกลับมามีชีวิตอีกครั้ง มิคาเอลกลับมาพร้อมชีวิตอันเป็นอมตะและพละกำลังที่เหนือมนุษย์ ทว่าเขากลับอยู่กลางแดดนาน ๆ ไม่ได้ มิคาเอลจึงได้ใช้เวลากลางวันหมกตัวอยู่แต่ในคฤหาสน์ ส่วนกลางคืนเขาจะออกไปช่วยงานในกิจการของครอบครัว มิคาเอลเป็นชายหนุ่มที่มีจิตใจดี และค่อนข้างที่จะอ่อนไหวง่ายจากการประคบประหงมของครอบครัว เขาจึงเลือกที่จะดื่มเลือดสัตว์แทนเลือดมนุษย์ เมื่อกาลเวลาผันผ่านไปเอิร์ลและเคาท์เตสไคเซอร์ได้สิ้นใจด้วยโรคชรา มิคาเอลที่มีชีวิตอมตะทนไม่ได้ที่จะเห็นคนรอบตัวที่ตัวเองรักจากไปทีละคน เขาจึงเลือกที่จะย้ายออกจากคฤหาสน์ของตัวเองและสละตำแหน่งเอิร์ลแห่งไคเซอร์ให้กับญาติที่ไว้ใจได้ผู้หนึ่ง แต่ก็เพียงแค่ในนามเท่านั้น เพราะมิคาเอลนั้นไม่ยอมให้สิ่งที่พ่อและแม่หามาอย่างยากลำบากนั้นต้องตกไปให้ผู้อื่นมาถลุงเล่น\n\nหลังจากนั้นตัวเขาก็ได้เดินทางเปลี่ยนที่อยู่ไปเรื่อย ๆ ก่อนที่จะพบเข้ากับหมู่บ้านเอลิเชียนในช่วงต้นศตวรรษที่ 20 เขาจึงได้ตัดสินใจที่จะย้ายมาใช้ชีวิตที่หมู่บ้านเอลิเชียนอย่างถาวร แต่แล้วก็มีเหตุที่ทำให้เขานั้นต้องออกจากหมู่บ้านไปนานเป็นสิบ ๆ ปี เพื่อตามหาหลานชายที่กลายเป็นแวมไพร์ที่เขาไม่เคยรู้ว่ามีอย่างเอสเตแวน เมื่อหาจนพลิกแผ่นดินก็ไม่พบ มิคาเอลจึงได้เลือกที่จะกลับมาปักหลักที่หมู่บ้านเอลิเชียนอีกครั้งในปี 2024 และได้สมรสกับ ลิลิธ พริมูแวร์ แซงกวิสิค (สกุลเดิม) เมื่อวันคริสต์มาสในปีเดียวกัน ซึ่งทั้งคู่นั้นเคยพบกันที่อังกฤษมาก่อน แต่สุดท้ายก็ได้มาตกหลุมรักกันที่เอลิเชียนและตกลงแต่งงานเป็นคู่สามีภรรยาในที่สุด",
    personality: "เป็นคนที่จิตใจดี ฉลาด แต่ค่อนข้างเก็บตัว ไม่ค่อยได้ออกมาพบปะกับผู้คนมากนัก แต่ถ้าได้สนิทกับใครเขามักจะเป็นฝ่ายชวนพูดเสียมากกว่า ในเวลาว่างมักจะหมกตัวอ่านหนังสือและทำเพลงส่งให้ค่ายเพลงที่บ้าน มักจะไม่ค่อยอยากสนิทสนมกับผู้อื่นมากนักเนื่องจากเขากลัวการสูญเสียเหมือนที่เคยสูญเสียครอบครัวและคนที่รักคนอื่น ๆ รักภรรยามาก และมักจะตามใจเธอเสมอ หลังจากย้ายมาอยู่หมู่บ้านเอลิเชียน มิคาเอลก็ได้เปิดใจคบคนอื่นเป็นเพื่อนบ้างแล้ว",
    relationCount: 2,
    relName1: "Lilith P. Kaiser", relType1: "Wife",
    relName2: "Flanklin D. Bloodworth", relType2: "BFF",
    relName3: "", relType3: "",
    relName4: "", relType4: "",
    relName5: "", relType5: "",
    relName6: "", relType6: "",
