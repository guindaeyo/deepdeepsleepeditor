...
function schedulePreviewResize(
  ...
  iframe.addEventListener("load", () => {
    ...
    setTimeout(runResize, 350);
    setTimeout(runResize, 700);
    setTimeout(runResize, 1200);
    setTimeout(runResize, 2200);
  });
}
...
const foodReviewPreviewCss = `<style data-review-preview-only>.dds-preview-target,.dds-card-preview-target{width:1000px!important;min-width:1000px!important;max-width:1000px!important}.fdpopup-wrap{width:1000px!important;min-width:1000px!important;max-width:1000px!important;margin:0!important}.fdpopup-container{width:760px!important;max-width:760px!important}</style>`;
...
function updateFoodReview() {
  ...
  const previewMarkup =
    foodReviewPreviewCss +
    buildFoodReviewMarkup(data);

  if (foodReviewPreview) {
    foodReviewPreview.srcdoc =
      buildEditorPreviewDocument(
