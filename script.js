...
<img src="${escapeHtml(data.imageLeftOne)}" class="jnsz-weirdo-in4img" style="margin-bottom: -30px;" alt="">
<img src="${escapeHtml(data.imageLeftTwo)}" class="jnsz-weirdo-in4img" style="margin-top: -10px;" alt=""></div>
<div class="column center-column">
<img src="${escapeHtml(data.imageCenter)}" class="jnsz-weirdo-center-img" alt=""></div>
<div class="column">
<img src="${escapeHtml(data.imageRightOne)}" class="jnsz-weirdo-in4img" style="margin-bottom: -30px;" alt="">
<img src="${escapeHtml(data.imageRightTwo)}" class="jnsz-weirdo-in4img" style="margin-top: -10px;" alt=""></div></div>
...
<div class="hihiz-main-image"><img src="${escapeHtml(data.image)}" alt="">
