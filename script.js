  ...
  function installBlankEditorFormsAndBbcodeTools() {
    ...
    if (
      ...
      window.queuePreviewDocument = function (
        ...
        if (
          window.__DDS_SUPPRESS_ARCHIVE_CARD_UPวันที่ในเอกสาร__ &&
    ...
    function clearPanelFields(panel, force = false) {
      ...
      window.__DDS_SUPPRESS_ARCHIVE_CARD_UPวันที่ในเอกสาร__ = true;
      ...
      try {
        ...
        window.__DDS_SUPPRESS_ARCHIVE_CARD_UPวันที่ในเอกสาร__ = false;
      }
    }
